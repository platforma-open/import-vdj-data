...
export type ImportVdjBlockContract = BlockContract;
export type ImportVdjBlockOutputs  = BlockOutputs;
export type ImportVdjBlockData     = BlockData;
export const ImportVdjBlockPointer = BlockPointer;
